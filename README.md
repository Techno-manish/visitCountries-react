...
<h1>Updating a Property of an Item inside List</h1>
<p>We should not update the property of a list item directly. To update the property of a list item, we should create a new object and return it to the list.</p>
  toggleIsFavorite = id => {
